...
class LicenseViewModel: ObservableObject {
    ...
    func startTrial() {
        // In this fork, the app is always treated as licensed.
        licenseState = .licensed
        NotificationCenter.default.post(name: .licenseStatusChanged, object: nil)
    }
    
    private func loadLicenseState() {
        // In this fork we treat the app as fully licensed, without trial/expiry.
        licenseState = .licensed
    }
    ...
    func removeLicense() {
        // Remove stored license data, but keep app usable in this fork
