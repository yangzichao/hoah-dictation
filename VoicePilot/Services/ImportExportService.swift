...
struct VoicePilotExportedSettings: Codable {
    let version: String
...
class ImportExportService {
    ...
    func exportSettings(enhancementService: AIEnhancementService, whisperPrompt: WhisperPrompt, hotkeyManager: HotkeyManager, menuBarManager: MenuBarManager, mediaController: MediaController, playbackController: PlaybackController, soundManager: SoundManager, whisperState: WhisperState) {
        ...
        let exportedSettings = VoicePilotExportedSettings(
        ...
        do {
            ...
            savePanel.nameFieldStringValue = "VoicePilot_Settings_Backup.json"
            savePanel.title = "Export VoicePilot Settings"
        ...
        DispatchQueue.main.async {
            if openPanel.runModal() == .OK {
                ...
                do {
                    ...
                    let importedSettings = try decoder.decode(VoicePilotExportedSettings.self, from: jsonData)
