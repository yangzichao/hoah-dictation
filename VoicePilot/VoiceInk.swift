...
struct VoicePilotApp: App {
    ...
    init() {
        ...
        AppLogger.defaultSubsystem = "com.prakashjoshipax.voicepilot.parakeet"
        ...
        // Attempt 2: Try in-memory storage
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = "VoicePilot couldn't access its storage location. Your transcriptions will not be saved between sessions."
    ...
    private static func createPersistentContainer(schema: Schema, logger: Logger) -> ModelContainer? {
        do {
            ...
            let appSupportURL = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
                .appendingPathComponent("com.prakashjoshipax.VoicePilot", isDirectory: true)
