            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("VoicePilot requires the following permissions to function properly")
                            .font(.system(size: 15))
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use VoicePilot anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow VoicePilot to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow VoicePilot to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "VoicePilot uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow VoicePilot to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "VoicePilot captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
