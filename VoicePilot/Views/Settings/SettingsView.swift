    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                SettingsSection(
                    icon: "command.circle",
                    title: "VoicePilot Shortcuts",
                    subtitle: "Choose how you want to trigger VoicePilot"
                ) {
                ...
                SettingsSection(
                    ...
                    subtitle: "Additional shortcuts for VoicePilot"
                ) {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            HStack(spacing: 8) {
                                ...
                                InfoTip(
                                    ...
                                    message: "Use middle mouse button to toggle VoicePilot recording."
                                )
                            }
            ...
            HStack(spacing: 12) {
                ...
                if showWarning {
                    ...
                    Image(systemName: "exclamationmark.triangle.fill")
                        .foregroundColor(.red)
                        .help("Permission required for VoicePilot to function properly")
                }
            }
